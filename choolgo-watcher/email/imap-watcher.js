...
const MAILBOX = process.env.EMAIL_CHECK_MAILBOX || 'INBOX';
const MARK_SEEN = process.env.EMAIL_MARK_SEEN !== 'false';
...
function startEmailWatcher() {
  ...
  if (!imapConfig.user || !imapConfig.password) {
    console.warn('[이메일] NAVER_EMAIL 또는 NAVER_PASSWORD 미설정 → 이메일 감시 비활성화');
    return;
  }
